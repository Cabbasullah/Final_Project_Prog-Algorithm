...
class sign_up_window(tk.Toplevel):
    def __init__(self, main):
        ...
        sign_up_window.geometry('400x350')#Defining the size of he window by using geometry method.
   
        #Labels
        
        self.txt2=Label(sign_up_window, text="please enter your registration credentials below", fg="#EE5007",bg="#2FA4FF",font=('Times New Roman',12))
        self.txt2.grid(row=0, sticky=N, pady=10)
        self.txt3=Label(sign_up_window, text="Name", fg="#EE5007", bg="#2FA4FF", font=('Times New Roman',12)).grid(row=1, sticky=W)
        self.txt4=Label(sign_up_window, text="Date of Birth", fg="#EE5007",bg="#2FA4FF",font=('Times New Roman',12)).grid(row=2, sticky=W)
        self.txt5=Label(sign_up_window, text="Gender", fg="#EE5007", bg="#2FA4FF",font=('Times New Roman',12)).grid(row=3, sticky=W)
        self.txt5=Label(sign_up_window,text="Password,", fg="#EE5007",bg="#2FA4FF", font=('Times New Roman',12)).grid(row=4, sticky=W)
  ...
  #Entry/Inputs
        ...
        self.button2.grid(row =5, sticky=N, pady=10)
